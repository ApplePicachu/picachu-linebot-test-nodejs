...
bot.on('message', function (event) {
    ...
    event.source.profile().then(function (profile) {
        linebot.pushMessage(process.env.LineAdminUserID, { type: 'text', text: profile.displayName });
        client.query(insertUserText, ['U828934c2ea1f46a8243398b2fe3e898c', profile.displayName], (err, res) => {
            ...
            linebot.pushMessage(process.env.LineAdminUserID, { type: 'text', text: err.stack });
        });
    });
